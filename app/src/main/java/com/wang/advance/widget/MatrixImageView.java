...
public class MatrixImageView extends ImageView {
    ...
    private void init() {
        ...
        int hidht = bitmap.getHeight();
        float s1= MeasureUtil.getScreenSize((Activity) mContext)[0];
        float s2=MeasureUtil.getScreenSize((Activity) mContext)[1];
        ...
        bitmap = Bitmap.createScaledBitmap(bitmap,(int)(s1+0.5f), (int)(s2*s1/width+0.5f),true);
