...
public class LoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        setIndicator(indicatorName,context);
        if (mIndicator==null){
    ...
    public void setIndicator(String indicatorName,Context context){
       if(TextUtils.isEmpty(indicatorName)){
           setIndicator(new BallClipRotateIndicator(context));
           return;
       }
       if(indicatorName.equals(BallClipRotateIndicator.class.getSimpleName())){
           setIndicator(new BallClipRotateIndicator(context));
           return;
       }
    }
