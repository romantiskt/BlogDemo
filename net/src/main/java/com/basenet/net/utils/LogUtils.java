...
public class LogUtils {
     ...
     * 日志输出时的TAG
     */
    private static String mTag = "Free";
    /**
     * 是否允许输出log
     */
            ...
            if (!TextUtils.isEmpty(msg)) {
                if (msg.length() > 4000) {
                    ...
                    for (int i = 0; i <= chunkCount; i++) {
                        int max = 4000 * (i + 1);
                        if (max >= msg.length()) {
                            Log.v("woopra", "chunk " + i + " of " + chunkCount + ":" + msg.substring(4000 * i));
                        } else {
                            Log.v("woopra", "chunk " + i + " of " + chunkCount + ":" + msg.substring(4000 * i, max));
                        }
                    }
                } else {
                    Log.v("woopra", msg.toString());
                }
            }
        }
    }
