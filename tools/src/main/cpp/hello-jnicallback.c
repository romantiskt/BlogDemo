...
Java_com_wang_tools_nativedemo_TaskNativeUtil_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (*env)->FindClass(env,
                                    "com/wang/tools/nativedemo/JniHandler");
...
Java_com_wang_tools_nativedemo_TaskNativeUtil_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_wang_tools_nativedemo_TaskNativeUtil_StopTicks(JNIEnv *env, jobject instance) {
