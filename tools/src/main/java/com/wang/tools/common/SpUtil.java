...
/**
 * Created by wangyang on 2018/5/30.上午11:11
 */
...
public final class SpUtil {
    ...
    private SpUtil(final String spName) {
        sp = CommonEngine.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SpUtil(final String spName, final int mode) {
        sp = CommonEngine.getContext().getSharedPreferences(spName, mode);
    }
